...
?>
 <!DOCTYPE html>
	...
	<title>Control Google Drive</title>
...
body, html {
  background-image: url(https://2img.net/h/i590.photobucket.com/albums/ss349/aira_ann07/Bleach_-_Kuchiki_Rukia.png);
...
body, html {
  background-image: url(https://static3.cbrimages.com/wordpress/wp-content/uploads/2019/12/Rukia-featured-image.jpg);
 background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
  height: 100%;
	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
				...
				<div class="col-md-11" id="sub">
					<div id="sub-block">
						<div class="row">
						    <div class="col-md-7">
						        <div class="form-group">
						        	<label class="font-weight-bold">Subtitulos</label>
			...
			<div class="form-group">
				...
				<input type="text" name="poster" class="form-control" placeholder="Ex:https://2img.net/h/i590.photobucket.com/albums/ss349/aira_ann07/Bleach_-_Kuchiki_Rukia.png" onclick="this.select()">
			</div>
		...
		<div class="form-group">
			...
			<input type="text" id="url-encode" class="form-control" placeholder="La URL  se mostrará aquí ..." onclick="this.select()">
		</div>

		<div class="form-group">
			<label class="font-weight-bold">Iframe:</label>
			<textarea rows="5" class="form-control" id="iframe-encode" placeholder="La URL con iframe se mostrará aquí ..." onclick="this.select()"></textarea>
		</div>
...
{
	echo '<p>Correo o Contraseña Invalidos</p>';
}
?>
</body>
</html>