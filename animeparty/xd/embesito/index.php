...
<input type="submit" class="btn btn-primary" value="Enviar" title="to post" />
			...
			?>					
<label style="color: #ffc119;"></label><br><textarea class="form-control" cols="100" rows="4"><?php echo "http://localhost/animeparty/xd/embesito/encriptar.php?v=".$urlEncode; ?></textarea><br><br>
</div>
								</div>
							</div>
							<div class="row">
