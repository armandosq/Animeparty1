<?php
	...
	if(isset($_POST['titulo'])){
		...
		$vid = '../vid/'.md5(sha1($n.$_FILES["thumb"]["name"])).$exts;

		move_uploaded_file($_FILES['thumb']['tmp_name'], "img/".$img);
		move_uploaded_file($_FILES['video']['tmp_name'], "vid/".$vid);
	...
	<div class="content">
		...
		<div class="container">
			...
			<form class="itemss" action="" method="post" enctype="multipart/form-data">
				<label for="titulo">Nombre del player</label>
				...
				<label for="video">Seleccione  video [.mp4]</label>
