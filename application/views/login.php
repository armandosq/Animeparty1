    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" id="login_form">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Iniciar</h3>
          
          <div class="row">
            <?php if($this->db->get_where('config' , array('title' =>'google_login_enable'))->row()->value =='1'): ?>
            <div class="col-sm-6">
              <div class="form-group">
                <a class="btn btn-gplus" href="<?php echo $login_url; ?>"><i class="fa fa-google-plus left"></i> Google </a>
              </div>
            </div>
          <?php endif; ?>
          <?php if($this->db->get_where('config' , array('title' =>'facebook_login_enable'))->row()->value =='1'): ?>
            <div class="col-sm-6">
              <div class="form-group">
                <a class="btn btn-fb" href="<?php echo $facebook_login_url; ?>" ><i class="fa fa-facebook left"></i> Facebook</a>
              </div>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" id="username" placeholder="Usuario" autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="utility">
              <div class="animated-checkbox">
                ...
                <p class="semibold-text mb-0"><a href="<?php echo base_url('user/signup'); ?>">Registrarse</a></p>
                </label>
              </div>
              <p class="semibold-text mb-0"><a data-toggle="flip">Olvido se Contarseña ?</a></p>
            </div>
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block" id="btn-login">iniciar <i class="fa fa-sign-in fa-lg"></i></button>
          </div>
        </form>
        <form class="forget-form" method="post" action="<?php echo base_url().'user/forget_password/do_reset' ?>">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>Olvido su contraseña ?</h3>
          <div class="form-group">
            <label class="control-label">EMAIL</label>
            <input class="form-control" type="text" name="email" value="<?php if(isset($email)){ echo $email;} ?>" placeholder="Email">
          </div>
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block">Resetear<i class="fa fa-unlock fa-lg"></i></button>
          </div>
          <div class="form-group mt-20">
            <p class="semibold-text mb-0"><a data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i>Ir a Inicio</a></p>
          </div>
        </form>
      </div>
    </section>
        ...
        $("#login_form").submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (login == "Hecho") {
                        Command: toastr["Hecho"]("Exitoso", "Hecho")
                        toastr.options = {
                            "closeButton": false,
                            "debug": false,
                            "newestOnTop": false,
                      ...
                      setTimeout(' window.location.href = "' + redirect + '"; ', 2000);
                        ...
                        $("#error").fadeIn(1000, function() {
                            Command: toastr["Error"]("Usuario o Contraseña Erroneas..", "Opps")
                            toastr.options = {
                              "closeButton": false,
                              "debug": false,
                              "newestOnTop": false,
