        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12 text-right">
                <ul class="breadcrumb">
                    ...
                    <li class="">Mi Cuenta</li>
                    <li class="active">Ver Despues</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="profiles-wrap">
                    ...
                    <div class="pp-main col-md-9 col-sm-9">
                        <div class="ppm-head">
                            <div class="ppmh-title"><i class="fa fa-clock-o mr5"></i> Lsita de Deseos</div>
                        </div>
                                ...
                                <div class="latest-movie movie-opt">
                                    <table class="table table-striped">
                                        ...
                                        <tr id="row_<?php echo $favorite_videos['wish_list_id'];?>">
                                            ...
                                            <td valign="top">
                                                <div>
                                                    <p <?php if($videos['is_tvseries'] =='1'){ echo base_url('tv-series/watch/'.$videos['slug']);}else{  echo base_url('watch/'.$videos['slug']);}?>>   <h3 style="color: white;"><?php echo $videos['title'];?></h3>  </p>
                                                </div>
