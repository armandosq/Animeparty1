...
<div class="movie-payer">
    ...
    <?php  if($file_source=='m3u8' || $file_source=='flv'): ?>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/videojs-contrib-hls/6.13.0/videojs-contrib-hls.min.js"></script>
    <?php endif; ?>
        <video id="play" class="video-js vjs-big-play-centered skin-<?php echo $player_color_skin; ?> vjs-16-9" controls preload="none" width="1000" height="1000" poster="<?php echo $this->common_model->get_video_poster_url($watch_videos->videos_id); ?>" data-setup="{}">                            <!-- video source -->
                <?php
      ...
      <!--  https://cdnjs.cloudflare.com/ajax/libs/videojs-contrib-hls/5.14.1/videojs-contrib-hls.min.js -->
		...
		<?php if($file_source=='youtube'): ?>
	       ...
	       <video id="play" class="video-js vjs-big-play-centered skin-<?php echo $player_color_skin; ?> vjs-16-9" poster="<?php echo $this->common_model->get_video_poster_url($watch_videos->videos_id); ?>">
	        ...
	        <!-- youtube -->
	        <script src="<?php echo base_url(); ?>assets/player/plugins/videojs-youtube/plyr.js"></script>
		...
		if ($('#trailer_div').hasClass('hidden')) {
			...
			$('#watch_button').html('<?php echo '<i class="fa fa-eye"></i> '.get_phrase('watch_videos') ?>');
			player.pause();
		}
