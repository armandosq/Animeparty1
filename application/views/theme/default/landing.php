		...
		<div id="bh-header">
			<div id="bhh-menu">
				<ul class="top-menu">
					...
					<li><a href="<?php echo base_url('movies'); ?>" title="<?php echo trans('movies'); ?>"><?php echo trans('movies'); ?></a></li>
					<?php 
		            ...
		            ?>
					<li><a href="<?php echo base_url('tv-series'); ?>" title="<?php echo trans('tv_series'); ?>"><?php echo trans('tv_series'); ?></a></li>
					<?php endif; ?>
					<?php 
				...
				<div class="clo-md-12">
					<div style="margin-bottom: 40px;">
						<a href="<?php echo base_url(); ?>">
							<img src="<?php echo base_url(); ?>uploads/system_logo/<?php echo ovoo_config('logo'); ?>" alt="logo" style="
    width: 309px;
">
						</a>
			...
			<div class="row text-center" style="margin-top: 20px;">
				<a href="<?php echo base_url('all-movies') ?>" class="btn btn-success btn-all-movie"><?php echo trans('brows_all_movies_and_tvseries'); ?></a>
