    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Miembro</h4>
            </div>
            <div class="modal-body">
                ...
                <form id="login_form" class="form-horizontal m-t-20" role="form">
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <button id="btn-login" class="btn btn-success btn-block text-uppercase waves-effect waves-light" type="submit"><i class="fa fa-sign-in" aria-hidden="true"></i>Iniciar</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer text-center">No eres miembro <a id="open-register" data-dismiss="modal" data-target="#pop-signup" data-toggle="modal" title="">Crear Cuenta</a> </div>
        </div>
    </div>
</div>
<!-- End Modal login -->
...
<div class="modal fade modal-cuz" id="pop-signup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="form-group ">
        <div class="col-xs-12">
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" id="username" name="username" value="<?php if(isset($username)){ echo $username;} ?>" class="form-control" placeholder="Usuario" required>
            </div>
        </div>
    </div>
    ...
    <div class="form-group text-center m-t-40">
        <div class="col-xs-12">
            ...
            <div class="modal-footer text-center"><?php echo trans('already_have_a_account?'); ?> <a id="open-register" data-dismiss="modal" data-target="#pop-login" data-toggle="modal" title="">iniciar</a> </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $('document').ready(function() {
        ...
        $("#login_form").validate({
            ...
            messages: {
                password: {
                    required: "Porfavor ingrese su contrasela"
                },
                username: "Porfavor ingrese su e-mail",
            },
...

                {
                    ...
                    if (login == "success") {
                        ...
                        $("#error_login").fadeIn(1000, function() {
                            $("#error_login").html('<div class="alert alert-danger"><strong>Opps!</strong> Error en usuario o contraseña</div>');

                            $("#btn-login").html('<i class="fa fa-sign-in" aria-hidden="true"></i> &nbsp; Iniciar');
                        });
                    }
                }
            });
