        ...
        <div class="widget-body">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <td>#</td>
                        <td><?php echo $total_rows; ?> Resultados</td>
                        <td>Calidad</td>
                        <td>Genero</td>
                        <td>Tipo de emision</td>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td> <img class="thumb" src="<?php echo $this->common_model->get_video_thumb_url($videos['videos_id']); ?>" alt="<?php echo $videos['title'];?>"> <a class="name" href="<?php echo base_url('watch/'.$videos['slug'])?>" title="<?php echo $videos['title'];?>"><?php echo $videos['title'];?></a> </td>
