            ...
            <div class="col-md-12 col-sm-12">
                <div class="profiles-wrap">
                            ...
                            <ul>
                                ...
                                <li class="">
                                    <a href="<?php echo base_url('my-account/watch-later'); ?>">
                                        <i class="fi ion-ios-clock-outline m-r-10"></i> Mirar Despues
                                </li>
                                <li class="">
                    ...
                    <div class="pp-main col-md-9 col-sm-9">
                        <div class="ppm-head">
                            <div class="ppmh-title"><i class="fa fa-key mr5"></i>Cambiar Contraseña</div>
                        </div>
                            ...
                            <div class="uc-form">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        <label for="password" class="col-sm-4 control-label">Contraseña Antigua</label>

                                        <div class="col-sm-8">
                                            <input name="password" type="password" class="form-control" id="full_name" value="" placeholder="" required>

                                            <span id="error-full_name" class="help-block error-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="new_password" class="col-sm-4 control-label">Nueva Contraseña</label>

                                        <div class="col-sm-8">
                                            <input name="new_password" type="password" class="form-control" id="full_name" value="" placeholder="" required>

                                            <span id="error-full_name" class="help-block error-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="retype_new_password" class="col-sm-4 control-label">Confirmar</label>

                                        <div class="col-sm-8">
                                            <input name="retype_new_password" type="password" class="form-control" id="full_name" value="" placeholder="" required>
