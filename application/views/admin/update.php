      ...
      <div class="panel panel-border panel-primary">
        ...
        <div class="panel-body">
          ...
          <div class="form-group row">
            <label class="control-label col-sm-3">Version Actual</label>
            <div class="col-sm-3">
          ...
          <div class="col-sm-offset-3 col-sm-9 m-t-15">
            <button type="submit" class="btn btn-sm btn-primary"><span class="btn-label"><i class="fa fa-upload"></i></span>Proceder</button>
          </div>
          <?php echo form_close(); ?>
        </div>
      </div>
