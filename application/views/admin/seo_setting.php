      ...
      <div class="row">
        ...
        <div class="panel panel-border panel-primary col-md-6">
          <div class="panel-heading">
            <h3 class="panel-title">Seo Basico</h3>
          </div>
          <div class="panel-body">
            <!-- panel  -->
            <div class="alert alert-info col-sm-12 col-md-offset-3">
              <p><strong><?php echo trans('note'); ?>: </strong></p>
            </div>

            <div class="form-group row">
              <label class=" col-sm-4 control-label">XLM URL:</label>
              <div class="col-sm-8">
        ...
        <div class="panel panel-border panel-primary col-md-6">
          ...
          <div class="panel-body">
            <div class="form-group">
              <label class=" col-sm-12 control-label">Titulo Seo</label>
              <div class="col-sm-12">
            ...
            <div class="form-group">
              <label class=" col-sm-12 control-label">Seo Key</label>
              <div class="col-sm-12">
            ...
            <div class="form-group">
              <label class="control-label col-md-3">Seo Descripcion</label>
              <div class="col-sm-12">
