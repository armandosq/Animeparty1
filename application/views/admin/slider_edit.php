...
<h4 class="text-center">Editar Slider</h4>
<hr>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select class="form-control m-bot15" name="action_type" id="action_type">
          <option value="movie" <?php if($row['action_type']=='movie'): echo "selected"; endif; ?>>Peliculas</option>
          <option value="tvseries" <?php if($row['action_type']=='tvseries'): echo "selected"; endif; ?>>Animes</option>
          <option value="external_browser" <?php if($row['action_type']=='external_browser'): echo "selected"; endif; ?>>Abrir URL</option>
          <option value="webview" <?php if($row['action_type']=='webview'): echo "selected"; endif; ?>>Abrir WebView URL</option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
        <select class="form-control m-bot15" name="publication">
            <option value="1"  <?php if($row['publication']=='1'){echo 'selected';} ?>>Publicado</option>
            <option value="0"  <?php if($row['publication']=='0'){echo 'selected';} ?>>No Publicado</option>
        </select>
    </div>
</div>
<?php endforeach; ?>
