...
<html lang="en">
	...
	<body id="body-search">
		<div id="bh-header">
			<div id="bhh-menu">
				<ul class="top-menu">
					<li class="active"><a href="<?php echo base_url(); ?>" title="Inicio">Inicio</a></li>
					<li><a href="<?php echo base_url('movies'); ?>" title="Peliculas">Peliculas</a></li>
					<?php 
		            ...
		            ?>
					<li><a href="<?php echo base_url('tv-series'); ?>" title="Animes">Animes</a></li>
					<?php endif; ?>
					<?php 
		...
		<div class="copyright footer_container">
			<div class="container">
				<div class="row text-center">
					<p>AnimeParty <?php echo date("Y"); ?> </p>
