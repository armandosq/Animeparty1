            ...
            <div class="panel panel-border panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <?php echo trans('edit'); ?> <?php echo $ads_info->ads_name; ?> ADS
                    </h3>
                </div>
                <div class="panel-body">
                    <!-- panel  -->
                    <div class="form-group">
                        <label class="control-label col-md-3">ADS (<?php echo $ads_info->ads_size; ?>)</label>
                        <div class="col-sm-3">
                            <select class="form-control m-bot15" id="ad_option" name="ads_type">
                                <option value="0" id="ad_disable">Desactivado</option>
                                <option value="image" <?php if ($ads_info->ads_type == 'image' && $ads_info->enable == '1') {
                                                            echo 'selected';
                                                        } ?> id="ad_image_selection">Imagen</option>
                                <option value="code" <?php if ($ads_info->ads_type == 'code' && $ads_info->enable == '1') {
                                                            echo 'selected';
                                                        } ?> id="ad_code_selection">ADS CODE</option>
                            </select>
                        </div>
                    </div>
                    <div id="ad_image_section" style="display:none;">
                        <div class="form-group">
                            <label class="control-label col-sm-3"m>IMAGEN</label>
                            <div class="col-sm-9">
