    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        ...
        <div class="panel-body">
          ...
          <div class="form-group row">
            <label class="control-label col-sm-3 ">Publicado</label>
            <div class="col-sm-6">
              <div class="toggle">
                <label>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <select class="form-control" name="season_order" required>
                  <option value="ASC" <?php if ($season_order == "ASC") { echo "selected";} ?>>Ascendiente </option>
                  <option value="DESC" <?php if ($season_order == "DESC") { echo "selected";} ?>>Decendiente</option>
                </select>
            </div>
          </div>

          <div class="form-group row">
            <label class="control-label col-sm-3 ">Orden de Episodio</label>
            <div class="col-sm-3">
              <select class="form-control" name="episode_order" required>
                  <option value="ASC" <?php if ($episode_order == "ASC") { echo "selected";} ?>>As</option>
                  <option value="DESC" <?php if ($episode_order == "DESC") { echo "selected";} ?>>Des</option>
                </select>
            </div>
          </div>
