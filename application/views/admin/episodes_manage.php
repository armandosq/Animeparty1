...
<div class="card">
  <div class="row justify-content-md-center">
    <div class="col-md-6">
      <a class="btn btn-sm btn-primary waves-effect mb-20" href="<?php echo base_url('admin/seasons_manage/') . $param1; ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>Atras</a>
      <a class="btn btn-sm btn-primary waves-effect mb-20" href="<?php echo base_url('watch/') . $slug; ?>" target="_blank"> <span class="btn-label"><i class="fa fa-eye"></i></span>Ver</a><br><br>
      ...
      <div class="panel panel-border panel-primary">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">Agregar</a>
          </li>
          ...
          <div class="tab-pane active" id="tabs-1" role="tabpanel">
            <?php echo form_open_multipart(base_url('admin/episodes_upload')); ?>           
              ...
              <div class="form-group">
                <label class="control-label">Nombre de Episodios</label>&nbsp;&nbsp;<input id="episodes_name" type="text" name="episodes_name" class="form-control" placeholder="Episode-1" required="">
              </div>
              <div class="form-group">
        ...
        <div class="col-md-12">
          <div class="panel panel-border panel-primary">
            ...
            <div class="panel-body">
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <li><a class="dropdown-item" href="<?php echo base_url('admin/episodes_manage/edit/'.$video_file['episodes_id']); ?>">Editar</a></li>
                            ...
                            <?php if ($video_file['file_source'] != 'youtube' && $video_file['file_source'] != 'vimeo' && $video_file['file_source'] != 'embed') : ?>
                              <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/tvseries_subtitle_add/' . $video_file['videos_id'] . '/' . $video_file['seasons_id'] . '/' . $video_file['episodes_id']; ?>" id="menu">Agregar Subs</a> </li>
                            <?php endif; ?>
                            <li><a class="dropdown-item" title="Eliminar" href="#" onclick="delete_row('episodes',<?php echo urldecode($video_file['episodes_id']); ?>)" class="delete">Eliminar</a> </li>
                          </ul>
                        </div>
                      </td>
                    </tr>
              ...
              <div class="pull-right"><button type="submit" class="btn btn-primary btn-sm">Guardar</button></div>
              <?php echo form_close();?>
            </div>
          </div>
        </div>
