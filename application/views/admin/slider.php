          ...
          <div class="swiper-slide" style="background-image: url('<?php echo $this->common_model->get_video_poster_url($videos->videos_id); ?>');">
              ...
              <span class="slide-caption">
                ...
                <div class="slide-caption-info">
                  ...
                  <div class="block"><strong>Duracion:</strong> <?php echo $videos->runtime; ?></div>
                  <div class="block"><strong>Año:</strong> 2019</div>
                  <div class="block"><strong>IMDb:</strong> <?php echo $videos->imdb_rating;?></div>
                </div>
                <a href="<?php echo base_url('watch/'.$videos->slug);?>" >
                  <div class="btn btn-sm btn-success mt20" style="margin-top: 10px;">Ver </div>
                </a>
              </span>
          </div>
        <?php endforeach; ?>
