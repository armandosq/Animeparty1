<?php
    $system_name              =   ovoo_config('AnimeParty');
    $system_short_name        =   ovoo_config('AnimeParty');
    $site_name                =   ovoo_config('AnimePArty');
    $business_address         =   ovoo_config('Localizacion');
    $system_email             =   ovoo_config('Email');
    $business_phone           =   ovoo_config('Telefono');
...
<head>
    ...
    <meta name="author" content="AnimeParty">
    <meta name="copyright" content="AnimeParty" <?php echo date("Y"); ?> >
...
<body class="app sidebar-mini rtl <?php //if(isset($page_name) && ($page_name=='videos_add' || $page_name=='videos_edit'|| $page_name=='videos_manage')){ echo 'sidebar-collapse';}  
    ...
    <header class="app-header hidden-print"><a class="app-header__logo" href="<?php echo base_url(); ?>">
        ...
        <ul class="app-nav">
            <!-- visit website -->
            <li><a class="app-nav__item" href="<?php echo base_url(); ?>" target="_blank">Visitar Web</a></li>
            <!-- language switch -->
            ...
            <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><img src="<?php echo $this->common_model->get_img('user', $this->session->userdata('user_id')) . '?' . time(); ?>" class="img-circle" alt="photo" height="20"></a>
                <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    <li><a class="dropdown-item" href="<?php echo base_url(); ?>admin/manage_profile"><i class="fa fa-user fa-lg"></i>Perfil</a></li>
                    <li><a class="dropdown-item" href="<?php echo base_url(); ?>admin/manage_profile"><i class="fa fa-lock fa-lg" aria-hidden="true"></i>Cambiar Contraseña</a></li>
                    <li><a class="dropdown-item" href="<?php echo base_url(); ?>login/logout"><i class="fa fa-sign-out fa-lg"></i> Salir</a></li>
                </ul>
            </li>
        </ul>
    </header>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#menu', function(e) {
                ...
                .fail(function() {
                    $('#dynamic-content').html('<i class="glyphicon glyphicon-info-sign"></i> Ocurrio Un Error');
                    $('#modal-loader').hide();
                });
            });
        });
