...
<div class="card">
  <div class="row justify-content-md-center">
    <div class="col-md-6">
      <a class="btn btn-sm btn-primary waves-effect mb-20" href="<?php echo base_url('admin/file_and_download/') . $video_file_info->videos_id; ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>Atras</a>
<br><br>
      <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Editar Episodio</h3>
        </div>
        <div class="panel-body">
            <?php echo form_open_multipart(base_url('admin/movie_file_update/'.$video_file_info->video_file_id)); ?>           
              ...
              <div class="form-group">
                <label class="control-label">/Label</label>&nbsp;&nbsp;<input id="label" type="text" value="<?php echo $video_file_info->label; ?>" name="label" class="form-control" placeholder="Episode-1" required="">
              </div>
              <div class="form-group">
                <label class="control-label">Orden</label>
                <input type="number" name="order" class="form-control" value="<?php echo $video_file_info->order; ?>" placeholder="0 al 9999" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group" <?php if($video_source =='upload'): echo 'style="display:none;"'; endif;?> id="url-input">
                ...
                <input type="text" name="url" id="url-input-field" class="form-control" value="<?php echo $video_file_info->file_url; ?>" placeholder="abc.mp4" <?php if($video_source !='upload'): echo 'required'; endif;?> ><br>
              </div>
