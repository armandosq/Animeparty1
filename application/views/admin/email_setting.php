    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        ...
        <div class="panel-body">
          ...
          <hr>
          <div class="form-group row">
            <label class="control-label col-md-3">Tipo de mail</label>
            <div class="col-sm-3">
          ...
          <div id="smtp">
            ...
            <div class="form-group row">
              <label class="col-sm-3 control-label">User SMTP </label>
              <div class="col-sm-9">
            ...
            <div class="form-group row">
              <label class="col-sm-3 control-label">Smtp PASS</label>
              <div class="col-sm-9">
