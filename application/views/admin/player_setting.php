    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Configuracion del reproductor</h3>
        </div>
        <div class="panel-body">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Recordar Volumen</label>
            <div class="col-sm-3">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Logo del reproductor</label>
            <div class="col-sm-3 ">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Logo por url</label>
            <div class="col-sm-9">
          ...
          <h4 class="text-left">Compartir</h4>
          <hr>
          <div class="form-group">
            <label class="col-sm-3 control-label">Compartir</label>
            <div class="col-sm-3 ">
              <div class="animated-checkbox checkbox-inline">
                <label>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">Compartir por facebook</label>
            <div class="col-sm-9">
