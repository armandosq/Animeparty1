...
<div class="card">
  <div class="row justify-content-md-center">
    <div class="col-md-6">
      <a class="btn btn-sm btn-primary waves-effect mb-20" href="<?php echo base_url('admin/seasons_manage/') . $episode_info->videos_id; ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>ir a temporadas</a>
      <a class="btn btn-sm btn-primary waves-effect mb-20" href="<?php echo base_url('admin/episodes_manage/') . $episode_info->videos_id.'/'.$episode_info->seasons_id; ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>Atras</a>
<br><br>
        ...
        <div class="panel-body">
            <?php echo form_open_multipart(base_url('admin/episodes_update/'.$episode_info->episodes_id)); ?>           
              ...
              <div class="form-group">
                <label class="control-label"><?php echo trans('episodes_name') ?></label>&nbsp;&nbsp;<input id="episodes_name" type="text" value="<?php echo $episode_info->episodes_name; ?>" name="episodes_name" class="form-control" placeholder="episodio 1" required="">
              </div>
              <div class="form-group">
                <label class="control-label">Orden</label>
                <input type="number" name="order" class="form-control" value="<?php echo $episode_info->order; ?>" placeholder="0 al 9999" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <button class="btn btn-sm btn-primary waves-effect" type="submit"> <span class="btn-label"><i class="fa fa-plus"></i></span>Guardar</button>
              </div>
            </form>
          </div>
        </div>
