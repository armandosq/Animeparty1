<div class="row card">
  <div class="col-sm-12">
    <div class="row">
      <div class="col-md-3">
        <a href="<?php echo base_url() . 'admin/videos_add'; ?>" class="btn btn-sm btn-primary waves-effect waves-light"><span class="btn-label"><i class="fa fa-plus"></i></span>Agregar Video</a> <br>
        <br>
      </div>
      <div class="col-md-9">
        <form class="form-inline pull-right" method="get" action="<?php echo base_url('admin/videos') ?>">
          <div class="form-group mx-sm-3 mb-2 ">
            ...
            <input type="text" name="title" value="<?php if (isset($title)) {
                                                      echo $title;
                                                    } ?>" class="form-control" id="title" placeholder="Titulo">
          </div>
          <div class="form-group mx-sm-3 mb-2">
            <label for="release" class="sr-only">Año</label>
          ...
          <div class="form-group mx-sm-3 mb-2">
            <label for="release" class="sr-only">Publicacion</label>
            ...
            <td>
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a class="dropdown-item" target="_blank" href="<?php echo base_url() . 'watch/' . $videos['slug']; ?>">Vista Previa</a></li>
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/file_and_download/' . $videos['videos_id']; ?>">Cargas y Descargas</a></li>
                  <li><a class="dropdown-item" href="<?php echo base_url() . 'admin/videos_edit/' . $videos['videos_id']; ?>">Editar</a></li>
                  <li><a class="dropdown-item" title="<?php echo trans('delete'); ?>" href="#" onclick="delete_row(<?php echo " 'videos' " . ',' . $videos['videos_id']; ?>)" class="delete">Eliminar</a> </li>
