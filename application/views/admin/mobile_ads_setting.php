    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-border panel-primary">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-3 ">
                    <select class="form-control" name="mobile_ads_network" required>
                      <option value="admob" <?php if($mobile_ads_network == 'admob'): echo "selected"; endif; ?>><?php echo trans("admob");?></option>
                      <option value="fan" <?php if($mobile_ads_network == 'fan'): echo "selected"; endif; ?>><?php echo trans("facebook_audiance_network");?></option>
                      <option value="startapp" <?php if($mobile_ads_network == 'startapp'): echo "selected"; endif; ?>><?php echo trans("startapp");?></option>
                    </select>
                  </div>
                </div>
                <strong><?php echo trans("admob");?></strong>
                <hr>
                ...
                <strong><?php echo trans("facebook_audiance_network");?></strong>
                <hr>
                ...
                <strong><?php echo trans("startapp");?></strong>
                <hr>
