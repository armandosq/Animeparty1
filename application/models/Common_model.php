...
public function latest_published_imd_Sabado($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Sabado');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
        $this->db->limit($limit);
        return $this->db->get('videos')->result_array();
    }
     public function latest_published_imd_Lunes()
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Lunes');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
  ...
  public function latest_published_imd_Martes($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Martes');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
        $this->db->limit($limit);
        return $this->db->get('videos')->result_array();
    }
     public function latest_published_imd_Miercoles($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Miercoles');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
        $this->db->limit($limit);
        return $this->db->get('videos')->result_array();
    }
     public function latest_published_imd_Jueves($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Jueves');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
        $this->db->limit($limit);
        return $this->db->get('videos')->result_array();
    }
      public function latest_published_imd_Viernes($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Viernes');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
        $this->db->limit($limit);
        return $this->db->get('videos')->result_array();
    }
     public function latest_published_imd_Sabados($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Sabado');
       ...
       public function latest_published_imd_Domingo($limit=12,$page='')
    {
        $this->db->where('publication', '1');
        $this->db->where('is_tvseries', '1');
        $this->db->where('meta_description', 'Domingo');
        $this->db->where('imdb_rating', 'Emision');
        $this->db->order_by("imdb_rating","");
        $this->db->limit($limit);
        return $this->db->get('videos')->result_array();
